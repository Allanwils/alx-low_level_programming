...
/**
 * jump_list - jump search for a linked list.
 * @list:  list to search.
 * @size:  size of list.
 * @value: value to search .
 *
 * Return: index of matched value; otherwise NULL if not found
 */
...
/**
 * recurse_helper - recursive implementation  of jump search.
 * @curr: current node of list
 * @size: size of the list.
 * @step: jump increment.
 * @val:  value to search.
 *
 * Return: index where value is found; otherwise  -1 if value not found
 */
listint_t *recurse_helper(listint_t *curr, size_t size, size_t step, int val)
{
